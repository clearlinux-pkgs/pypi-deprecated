...
Source0  : https://files.pythonhosted.org/packages/92/14/1e41f504a246fc224d2ac264c227975427a85caf37c3979979edb9b1b232/Deprecated-1.2.14.tar.gz
...
%prep
%setup -q -n Deprecated-1.2.14
cd %{_builddir}/Deprecated-1.2.14
pushd ..
cp -a Deprecated-1.2.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685241837
